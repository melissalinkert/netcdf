...
public class JTreeTable extends JTable {
    ...
    TreePath[] getSelectionPaths() { return selectionModel.getSelectionPaths(); }
    ...
    int setSelectionPath(TreePath path) {
      ...
      if (debugSelection) System.out.println("  getRowForPath = "+ rowno+" "+path);
  ...
  */
  public int incrSelected(boolean increment) {
    ...
    if (debug) System.out.println("  incrSelected to "+ rowno);
    return rowno;
  }
    ...
    public void tableChanged(TableModelEvent e) {
      if (debug) System.out.println("tableChanged " + autoCreateColumnsFromModel);
     ...
     * JTree.
     */
    public class TreeTableCellEditor extends ucar.nc2.ui.table.AbstractCellEditor implements
                 TableCellEditor {
